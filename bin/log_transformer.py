...
def create_all_transformation_plots_html(df, df_transformed, batchName, transformation_type='Log'):
    ...
    for metric_type in metric_types:
        ...
        for i, marker_col in enumerate(metric_cols):
            ...
            plot_filename = f'log_{batchName}_{metric_type.lower()}_{i:03d}_{safe_marker_name}.png'
...
def collect_and_transform(df, batchName, plotFraction, quantType, nucMark):
    ...
    all_plot_data = create_all_transformation_plots_html(df, bcDf, batchName, 'Log')
